                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="shop_name" name="shop_name" placeholder="Enter shop name"
                                       value="@if(isset($dataTypeContent->shop_name)){{ $dataTypeContent->shop_name }}@endif">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="details">Deatils</label>
                                <textarea name="details" class="form-control" id="details" cols="30" placeholder="Enter Shop Details" rows="10">@if(isset($dataTypeContent->address)){{ $dataTypeContent->address }}@endif</textarea>
